-- v_forms_pacing_status
-- Purpose: Dashboard-ready pacing/status for forms campaigns (LA time).
create or replace view public.v_forms_pacing_status as
with
time_ctx as (
  select
...
left join public.v_forms_baselines base
